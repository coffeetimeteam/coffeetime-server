...
class UserController(
    ...
    fun createUser(@RequestBody @Valid request: CreateUserRequest): ResponseEntity<ApiStatus> {
    ...
    @GetMapping("/my")
    fun getMemberInfo(@RequestHeader(HttpHeaders.AUTHORIZATION) token: String): ResponseEntity<UserResponse> {
